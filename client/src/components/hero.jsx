    ...
    return (
        ...
        <div className="relative min-h-screen flex items-center mt-3 justify-center overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center m-auto gap-4 px-4">
                ...
                <h2 className="text-4xl md:text-6xl font-bold text-white text-center">practice interviews. <span className='text-[#EFBF04]'>Land the job</span></h2>

                <p className="text-gray-300 text-center max-w-lg md:text-base">The only interview prep platform built for <span className='font-bold'>kenyan graduates and job seekers </span>.practice real questions asked by 
